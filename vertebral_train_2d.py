...
parser.add_argument('--dataset', type=str,
                    default='Vertebral', help='dataset name')
...
parser.add_argument('--data_dir', type=str, default='../../data/Vertebral', help='Data source')
...
def pretrain(args, snapshot_path):
    ...
    db_train = Vertebral(base_dir=args.data_dir, split="train", num=args.labeled_num, transform=transforms.Compose([
...
def ssl_train(args, snapshot_path):
    ...
    def worker_init_fn(worker_id):
        random.seed(args.seed + worker_id)
    db_train = Vertebral(base_dir=args.data_dir, split="train", transform=transforms.Compose([
        VertebralRandomGenerator(args.patch_size),
    ]))
    db_val = Vertebral(base_dir=args.data_dir, split="val")
