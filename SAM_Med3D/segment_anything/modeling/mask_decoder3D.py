...
class MaskDecoder3D(nn.Module):
    ...
    def forward(
        ...
        middle_output: bool=False,
        masked_feat_output: bool=False,
        ...
        if middle_output or masked_feat_output:
            masks, iou_pred, upsampling_embeddings = self.predict_masks(
                image_embeddings=image_embeddings,
                image_pe=image_pe,
                sparse_prompt_embeddings=sparse_prompt_embeddings,
                dense_prompt_embeddings=dense_prompt_embeddings,
                middle_output=middle_output,
                masked_feat_output=masked_feat_output,
            )
            ...
            # Prepare output
            return masks, iou_pred, upsampling_embeddings
        else:
