...
parser.add_argument('--exp', type=str,
                    default='train_Prostate_Cross_Teaching', help='experiment_name')
...
def Inference_model1(FLAGS):
    ...
    test_save_path = "../model/Cross_Teaching/Prostate_{}_{}_labeled/{}_predictions_model/".format(FLAGS.exp, FLAGS.labeled_num, FLAGS.model_1)
