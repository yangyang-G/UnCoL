...
class Pancreas(Dataset):
    ...
    def __init__(self, data_dir, split='train', num=None, patch_size=[128,128,128]):
        self._data_dir = data_dir

        train_path = os.path.join(self._data_dir, 'train.txt')
        test_path = os.path.join(self._data_dir, 'test.txt')
        ...
        self.image_list = [os.path.join(self._data_dir, item + ".h5") for item in self.image_list]
        if num is not None:
...
if __name__ == '__main__':
    ...
    data_dir = '/amax/data/luwenjing/P1_UPCoL/Datasets/Pancreas-processed'

    trainset = Pancreas(data_dir, split='train')
    testset = Pancreas(data_dir, split='test')
 
    train_sample = trainset[0] 
    test_sample = testset[0]
 
    print(len(trainset), train_sample['image'].shape, train_sample['label'].shape) # 62 torch.Size([1, 128, 128, 128]) torch.Size([128, 128, 128])
    print(len(testset), test_sample['image'].shape, test_sample['label'].shape) # 18 torch.Size([1, 128, 128, 128]) torch.Size([128, 128, 128])
