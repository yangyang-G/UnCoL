...
from datasets.atlas import ATLAS, RandomGenerator as ATLASRandomGenerator
...
parser.add_argument("--dataset", type=str, default="ATLAS", help="dataset name")
...
parser.add_argument("--data_dir", type=str, default="../../data/ATLAS", help="Data source")
...
def pretrain(args, snapshot_path):
    ...
    db_train = ATLAS(
        ...
        transform=transforms.Compose([ATLASRandomGenerator(args.patch_size)]),
    )
    db_val = ATLAS(base_dir=args.data_dir, split="val")
